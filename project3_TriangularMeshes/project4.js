...
class MeshDrawer
{
	...
	swapYZ( swap )
	{
		//changes orientations every time function is called, swap is not really needed...
		//if(swap == true){
		for(var j = 2; j < this.vertPos.length; j+=3){
	        let temp = this.vertPos[j-1];
	        this.vertPos[j-1] = this.vertPos[j];
	        this.vertPos[j] = temp;
	    }
		//}
	}
